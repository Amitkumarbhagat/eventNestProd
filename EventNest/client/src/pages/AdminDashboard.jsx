...
const AdminDashboard = () => {
    ...
    if (loading) return <div className="text-center py-20 text-xl font-semibold text-gray-600">Loading admin panel...</div>;

    return (
        <div className="max-w-7xl mx-auto space-y-8">
            <div className="bg-gradient-to-r from-gray-900 to-black text-white rounded-3xl p-6 sm:p-8 shadow-xl flex flex-col md:flex-row justify-between items-center gap-6 text-center md:text-left">
                <div>
            ...
            {showEventForm && (
                <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 animation-slideDown">
