...
const Home = () => {
    ...
    return (
        <div className="flex flex-col min-h-screen gap-10">
            {/* Hero Section */}
            <div className="relative bg-black text-white rounded-3xl overflow-hidden shadow-2xl">
            ...
            {loading ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {events.map(event => (
                        <div key={event._id} className="bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-100 hover:shadow-xl transition-all duration-300 hover:-translate-y-1 flex flex-col">
                            ...
                            <div className="p-6 flex-grow flex flex-col">
                                ...
                                <div className="mt-auto">
                                    ...
                                    <Link to={`/events/${event._id}`} className="block w-full text-center bg-gray-900 hover:bg-black text-white font-semibold py-2.5 rounded-lg transition">
                                        Explore Event
                                    </Link>
                                </div>
                            </div>
